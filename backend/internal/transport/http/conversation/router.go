...
func (m *Module) RegisterRoutes(authRequired *gin.RouterGroup) {
	...
	authRequired.GET("/conversation-input-resources", m.Handler.ListInputResources)
	...
	authRequired.GET("/conversations/:id/interactions", m.Handler.ListInteractions)
	authRequired.POST("/conversation-interactions/:interaction_id/respond", m.Handler.RespondInteraction)
	authRequired.POST("/conversations/:id/turns", m.Handler.StartTurn)
	authRequired.POST("/conversations/:id/turns/stream", m.Handler.StreamTurn)
